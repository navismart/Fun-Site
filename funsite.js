...
function monkeyCursor() {
  document.body.style.cursor = "url(https://navismart.github.io/Fun-Site/monkey-cursor.cur), auto";
}
...
function friedChickenCursor() {
  document.body.style.cursor = "url(https://navismart.github.io/Fun-Site/chicken-cursor.cur), auto";
}
